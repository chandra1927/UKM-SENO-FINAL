...
<main class="max-w-7xl mx-auto mt-10 px-6">
    <h1 class="text-3xl font-bold text-gray-700 mb-6">Pengeluaran</h1>

    <!-- Form Tambah Pengeluaran -->
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <h2 class="text-lg font-semibold text-blue-600 mb-4">Tambah Pengeluaran</h2>
        @if (session('success'))
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <h2 class="text-lg font-semibold text-blue-600 mb-4">Daftar Pengeluaran</h2>
