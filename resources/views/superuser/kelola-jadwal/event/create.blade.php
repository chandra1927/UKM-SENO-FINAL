...
<div class="container mx-auto p-8">
    ...
    <!-- Form -->
    <form action="{{ route('superuser.jadwal.event.store') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl max-w-2xl mx-auto">
        @csrf
        <div class="space-y-6">
            <!-- Judul -->
            <div>
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi"
                          ...
                          placeholder="Masukkan deskripsi event (opsional)" rows="5">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="text-red-500 text-sm mt-2 flex items-center">
                        <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                    </p>
            ...
            <div>
                ...
                <input type="text" name="waktu" id="waktu" value="{{ old('waktu') }}"
