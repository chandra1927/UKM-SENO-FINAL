...
<div class="container mx-auto p-8">
    ...
    <!-- Form -->
    <form action="{{ route('superuser.jadwal.latihan.update', $jadwalLatihan->id) }}" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl max-w-2xl mx-auto">
        @csrf
        @method('PUT')
        <div class="space-y-6">
            <!-- Kegiatan -->
            <div>
                ...
                <input type="text" name="kegiatan" id="kegiatan" value="{{ old('kegiatan', $jadwalLatihan->kegiatan) }}"
            ...
            <div>
                ...
                <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', $jadwalLatihan->tanggal) }}"
            ...
            <div>
                ...
                <input type="text" name="waktu_mulai" id="waktu_mulai" value="{{ old('waktu_mulai', $jadwalLatihan->waktu_mulai) }}"
            ...
            <div>
                ...
                <input type="text" name="waktu_selesai" id="waktu_selesai" value="{{ old('waktu_selesai', $jadwalLatihan->waktu_selesai) }}"
            ...
            <div>
                ...
                <input type="text" name="tempat" id="tempat" value="{{ old('tempat', $jadwalLatihan->tempat) }}"
            ...
            <div>
                ...
                <textarea name="catatan" id="catatan"
                          ...
                          placeholder="Masukkan catatan (opsional)" rows="5">{{ old('catatan', $jadwalLatihan->catatan) }}</textarea>
                @error('catatan')
                    <p class="text-red-500 text-sm mt-2 flex items-center">
                        <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                    </p>
