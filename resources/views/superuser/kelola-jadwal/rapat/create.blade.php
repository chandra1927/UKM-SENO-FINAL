...
@section('title', 'Tambah Jadwal Rapat')
...
<div class="container mx-auto p-8">
    ...
    <!-- Form -->
    <form action="{{ route('superuser.jadwal.rapat.store') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl max-w-2xl mx-auto">
        @csrf
        <div class="space-y-6">
            <!-- Agenda -->
            <div>
                ...
                <input type="text" name="agenda" id="agenda" value="{{ old('agenda') }}"
            ...
            <div>
                ...
                <textarea name="notulen" id="notulen"
                          ...
                          placeholder="Masukkan notulen (opsional)" rows="5">{{ old('notulen') }}</textarea>
                @error('notulen')
                    <p class="text-red-500 text-sm mt-2 flex items-center">
                        <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                    </p>
